...
import { TrackContext, TrackContextObject, TrackFetchContext, TrackFetchState } from "@/app/context";
...
export default function DemoPage({ params }: { params: { trackId: string } }) {
    ...
    const [fetchState, setFetchState] = useState<TrackFetchState>({ state: 'track', percent: -1 });
