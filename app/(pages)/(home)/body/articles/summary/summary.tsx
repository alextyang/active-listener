import { ArtistHoverMenu, TrackHoverMenu, AlbumHoverMenu, ArticleHoverMenu } from "@/app/(components)/metadata/textualHoverMenu";
import { TrackContext, ProgressContext } from "@/app/(domain)/context";
import { Article } from "@/app/(domain)/types";
