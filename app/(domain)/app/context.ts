import { PlaybackState, SimplifiedPlaylist, SpotifyApi, UserProfile } from "@spotify/web-api-ts-sdk";
import { SetStateAction, createContext } from "react";
import { CompleteArticle, TrackMetadataRecord } from "./types";
...
export type SpotifyClientObject = { api?: SpotifyApi, user?: UserProfile, isLoggingIn?: boolean, login: () => void, logout: () => void };
...
export type TrackContextObject = TrackMetadataRecord;
...
export type TrackSyncState = { state: 'track' | 'articles' | 'summary' | 'waiting', percent?: number, message?: string, isError?: boolean };
export const trackSyncMessages = { 'track': '', 'articles': 'Finding reviews for track...', 'summary': 'Generating summary...', 'waiting': '' };
export type TrackSyncContextObject = { state: TrackSyncState, update: (value: TrackSyncState) => void, retry: () => void };
